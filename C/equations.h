...
double dPdp(const double density, const double temp); // Pressure differentials
...
double dtau(const double radius, const double mass, const double density, const double temp, const double lum);  // delta(tau) for optical depth limit
